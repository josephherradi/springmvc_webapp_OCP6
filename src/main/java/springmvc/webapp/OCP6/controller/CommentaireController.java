...
public class CommentaireController {
	...
	public String saveCommentaire(@PathVariable("spotId") int spotId,@ModelAttribute("theComment") Commentaire theComment,HttpSession session,HttpServletRequest request) {
